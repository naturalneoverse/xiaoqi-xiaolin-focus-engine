...
const FALLBACK_BY_SCENE = {
  body_daily: "小麟在这儿，陪您慢慢听一听身体的边界。",
  body_week: "小麟在这儿陪着您。这一周，先照顾好此刻的自己。",
  weekly_time: "小麒在这儿。按您的节奏来，一步一步就好。",
  task_create: "小麒在这儿。按您的节奏来，一步一步就好。",
};

function pickFallback(scene) {
  const key = scene && FALLBACK_BY_SCENE[scene] ? scene : null;
  return key ? FALLBACK_BY_SCENE[key] : "小麟在这儿陪着您。这一周，先照顾好此刻的自己。";
}
