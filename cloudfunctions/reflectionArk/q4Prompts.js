...
3. 建议表述：落地参考 1–3 条均可，若有多条依次以「您可以尝试」「也可以尝试」「或者试着」起句，不重复使用同一句式，步子要小、可执行，不命令、不断言。
...
const Q4_CARD_FOCUS = {
  ...
  c1: `【本题重心·c1】回应「明天，打算怎么开始」：承接用户写下的第一步，1–3 条极轻量落地参考（依次以「您可以尝试」「也可以尝试」「或者试着」起句），禁止长篇方法论。`,
