...
3. 建议表述：落地参考 1–3 条均可，若有多条依次以「您可以尝试」「也可以尝试」「或者试着」起句，不重复使用同一句式，不命令、不断言。
...
const Q3_CARD_FOCUS = {
  c0: `【本题重心·c0】回应「哪些是你的课题，哪些是别人的」：复述用户已写划分，温和点出边界，1–3 条边界行动参考（依次以「您可以尝试」「也可以尝试」「或者试着」起句）。禁止编造具体冲突场景。`,
